...
public class PointsCredentials {
    ...
    public void setResult(String x, String y, String r){
        ...
        if(xx >= -rr/2 && xx <= 0 && yy <= 0 && yy >= -rr) this.result = "true";
        else if( xx*xx + yy*yy <= rr*rr && xx <= rr && xx >= 0 && yy <= 0 && yy >= -rr) this.result = "true";
        else if (xx <= 0 && xx >= -rr && yy >= 0 && yy <= rr && xx >= yy - rr) this.result = "true";
